...
import { BarChart3, ArrowRight, Waves, LogIn } from 'lucide-react'
    ...
    <div className="min-h-full bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link
            href="/login-portal"
            className="group relative flex flex-col items-start justify-between overflow-hidden rounded-2xl bg-gradient-to-br from-slate-700 via-slate-800 to-slate-900 p-8 text-white shadow-lg transition-all duration-200 hover:-translate-y-1 hover:shadow-2xl focus:outline-none focus:ring-4 focus:ring-slate-300 cursor-pointer"
          >
            <div className="absolute -top-12 -right-12 h-40 w-40 rounded-full bg-white/10 blur-2xl transition-transform duration-300 group-hover:scale-110"></div>
            <div className="relative z-10 flex items-center gap-3 mb-4">
              <div className="rounded-xl bg-white/15 p-3 backdrop-blur-sm">
            ...
            <p className="relative z-10 text-base text-slate-200 mb-6">
              Übersicht aller Anmeldemasken für Pool-Mitarbeitende, Planung
              und Admins. Für Tests und schnellen Rollenwechsel.
            </p>
            <span className="relative z-10 inline-flex items-center gap-2 rounded-lg bg-white/20 px-5 py-2.5 text-sm font-semibold backdrop-blur-sm transition-all duration-200 group-hover:bg-white/30">
              Öffnen
              <ArrowRight className="h-4 w-4 transition-transform duration-200 group-hover:translate-x-1" />
