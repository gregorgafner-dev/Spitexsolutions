...
export default async function PoolPlannerShiftRequestsPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8 space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Dienstanfragen</h1>
          <p className="text-sm text-gray-600">
            Erstelle Anfragen an alle Mitarbeitenden. Die schnellste Person erhält den Dienst.
          </p>
        </div>
      </div>
